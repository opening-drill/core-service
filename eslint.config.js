// ESLint 9 flat config. Enforces the project's no-`any` guarantee.
...
export default tseslint.config(
  ...
  {
    // Tests assert against loosely-typed response bodies (e.g. supertest's
    // `res.body: any`) — relax the unsafe-`any` family here only.
  ...
  {
    // The flat config itself is plain JS — skip type-aware rules.
